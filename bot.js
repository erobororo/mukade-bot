...
client.on("message", (message) => {
  ...
  if (!message.content.startsWith(love2) || message.author.bot) return;
  if (!message.content.startsWith(love3) || message.author.bot) return;
  if (!message.content.startsWith(love4) || message.author.bot) return;
  if (!message.content.startsWith(love5) || message.author.bot) return;
